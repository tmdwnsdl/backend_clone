...
import com.example.chatapplication.databinding.ListChatroomItemBinding
import com.example.chatapplication.databinding.ListTalkItemMineBinding
...
class RecyclerChatRoomsAdapter(val context: Context) :
    ...
    inner class ViewHolder(itemView: ListChatroomItemBinding) :
        ...
        var txt_Title = itemView.txtTItle
        var txt_message = itemView.txt_message
        var txt_date = itemView.txt_date
        var txt_chatCount = itemView.txt_isshown
    }
